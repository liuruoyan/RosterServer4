...
/**
 * Criteria class for the {@link com.cc.domain.EnumPfType} entity. This class is used
 * in {@link com.cc.web.rest.EnumPfTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-pf-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumPfTypeCriteria implements Serializable, Criteria {
    ...
    public EnumPfTypeCriteria(){
    }

    public EnumPfTypeCriteria(EnumPfTypeCriteria other){
    ...
    @Override
    public EnumPfTypeCriteria copy() {
        return new EnumPfTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumPfTypeCriteria that = (EnumPfTypeCriteria) o;
        return
