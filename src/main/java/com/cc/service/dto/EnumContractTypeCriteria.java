...
/**
 * Criteria class for the {@link com.cc.domain.EnumContractType} entity. This class is used
 * in {@link com.cc.web.rest.EnumContractTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-contract-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumContractTypeCriteria implements Serializable, Criteria {
    ...
    public EnumContractTypeCriteria(){
    }

    public EnumContractTypeCriteria(EnumContractTypeCriteria other){
    ...
    @Override
    public EnumContractTypeCriteria copy() {
        return new EnumContractTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumContractTypeCriteria that = (EnumContractTypeCriteria) o;
        return
    ...
    public String toString() {
        return "EnumContractTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
