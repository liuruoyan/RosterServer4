...
/**
 * Criteria class for the {@link com.cc.domain.EnumEmpType} entity. This class is used
 * in {@link com.cc.web.rest.EnumEmpTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-emp-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumEmpTypeCriteria implements Serializable, Criteria {
    ...
    public EnumEmpTypeCriteria(){
    }

    public EnumEmpTypeCriteria(EnumEmpTypeCriteria other){
    ...
    @Override
    public EnumEmpTypeCriteria copy() {
        return new EnumEmpTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumEmpTypeCriteria that = (EnumEmpTypeCriteria) o;
        return
