...
/**
 * Criteria class for the {@link com.cc.domain.EnumEmpTaxArea} entity. This class is used
 * in {@link com.cc.web.rest.EnumEmpTaxAreaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-emp-tax-areas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumEmpTaxAreaCriteria implements Serializable, Criteria {
    ...
    public EnumEmpTaxAreaCriteria(){
    }

    public EnumEmpTaxAreaCriteria(EnumEmpTaxAreaCriteria other){
    ...
    @Override
    public EnumEmpTaxAreaCriteria copy() {
        return new EnumEmpTaxAreaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumEmpTaxAreaCriteria that = (EnumEmpTaxAreaCriteria) o;
        return
