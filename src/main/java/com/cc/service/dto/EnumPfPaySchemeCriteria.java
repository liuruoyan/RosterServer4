...
/**
 * Criteria class for the {@link com.cc.domain.EnumPfPayScheme} entity. This class is used
 * in {@link com.cc.web.rest.EnumPfPaySchemeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-pf-pay-schemes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumPfPaySchemeCriteria implements Serializable, Criteria {
    ...
    public EnumPfPaySchemeCriteria(){
    }

    public EnumPfPaySchemeCriteria(EnumPfPaySchemeCriteria other){
    ...
    @Override
    public EnumPfPaySchemeCriteria copy() {
        return new EnumPfPaySchemeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumPfPaySchemeCriteria that = (EnumPfPaySchemeCriteria) o;
        return
    ...
    public String toString() {
        return "EnumPfPaySchemeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
