...
/**
 * Criteria class for the {@link com.cc.domain.EnumMaritalStatus} entity. This class is used
 * in {@link com.cc.web.rest.EnumMaritalStatusResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-marital-statuses?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumMaritalStatusCriteria implements Serializable, Criteria {
    ...
    public EnumMaritalStatusCriteria(){
    }

    public EnumMaritalStatusCriteria(EnumMaritalStatusCriteria other){
    ...
    @Override
    public EnumMaritalStatusCriteria copy() {
        return new EnumMaritalStatusCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumMaritalStatusCriteria that = (EnumMaritalStatusCriteria) o;
        return
    ...
    public String toString() {
        return "EnumMaritalStatusCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
