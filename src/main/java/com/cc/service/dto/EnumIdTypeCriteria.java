...
/**
 * Criteria class for the {@link com.cc.domain.EnumIdType} entity. This class is used
 * in {@link com.cc.web.rest.EnumIdTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-id-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumIdTypeCriteria implements Serializable, Criteria {
    ...
    public EnumIdTypeCriteria(){
    }

    public EnumIdTypeCriteria(EnumIdTypeCriteria other){
    ...
    @Override
    public EnumIdTypeCriteria copy() {
        return new EnumIdTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumIdTypeCriteria that = (EnumIdTypeCriteria) o;
        return
