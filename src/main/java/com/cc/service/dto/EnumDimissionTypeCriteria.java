...
/**
 * Criteria class for the {@link com.cc.domain.EnumDimissionType} entity. This class is used
 * in {@link com.cc.web.rest.EnumDimissionTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-dimission-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumDimissionTypeCriteria implements Serializable, Criteria {
    ...
    public EnumDimissionTypeCriteria(){
    }

    public EnumDimissionTypeCriteria(EnumDimissionTypeCriteria other){
    ...
    @Override
    public EnumDimissionTypeCriteria copy() {
        return new EnumDimissionTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumDimissionTypeCriteria that = (EnumDimissionTypeCriteria) o;
        return
    ...
    public String toString() {
        return "EnumDimissionTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
