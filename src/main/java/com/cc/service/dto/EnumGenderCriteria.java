...
/**
 * Criteria class for the {@link com.cc.domain.EnumGender} entity. This class is used
 * in {@link com.cc.web.rest.EnumGenderResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-genders?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumGenderCriteria implements Serializable, Criteria {
    ...
    public EnumGenderCriteria(){
    }

    public EnumGenderCriteria(EnumGenderCriteria other){
    ...
    @Override
    public EnumGenderCriteria copy() {
        return new EnumGenderCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumGenderCriteria that = (EnumGenderCriteria) o;
        return
