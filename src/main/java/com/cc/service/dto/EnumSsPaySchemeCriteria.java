...
/**
 * Criteria class for the {@link com.cc.domain.EnumSsPayScheme} entity. This class is used
 * in {@link com.cc.web.rest.EnumSsPaySchemeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-ss-pay-schemes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumSsPaySchemeCriteria implements Serializable, Criteria {
    ...
    public EnumSsPaySchemeCriteria(){
    }

    public EnumSsPaySchemeCriteria(EnumSsPaySchemeCriteria other){
    ...
    @Override
    public EnumSsPaySchemeCriteria copy() {
        return new EnumSsPaySchemeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumSsPaySchemeCriteria that = (EnumSsPaySchemeCriteria) o;
        return
    ...
    public String toString() {
        return "EnumSsPaySchemeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
