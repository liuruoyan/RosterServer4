...
/**
 * Criteria class for the {@link com.cc.domain.EnumSsStatus} entity. This class is used
 * in {@link com.cc.web.rest.EnumSsStatusResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-ss-statuses?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumSsStatusCriteria implements Serializable, Criteria {
    ...
    public EnumSsStatusCriteria(){
    }

    public EnumSsStatusCriteria(EnumSsStatusCriteria other){
    ...
    @Override
    public EnumSsStatusCriteria copy() {
        return new EnumSsStatusCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumSsStatusCriteria that = (EnumSsStatusCriteria) o;
        return
