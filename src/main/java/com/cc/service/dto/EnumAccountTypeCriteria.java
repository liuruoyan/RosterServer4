...
/**
 * Criteria class for the {@link com.cc.domain.EnumAccountType} entity. This class is used
 * in {@link com.cc.web.rest.EnumAccountTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-account-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumAccountTypeCriteria implements Serializable, Criteria {
    ...
    public EnumAccountTypeCriteria(){
    }

    public EnumAccountTypeCriteria(EnumAccountTypeCriteria other){
    ...
    @Override
    public EnumAccountTypeCriteria copy() {
        return new EnumAccountTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumAccountTypeCriteria that = (EnumAccountTypeCriteria) o;
        return
    ...
    public String toString() {
        return "EnumAccountTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
