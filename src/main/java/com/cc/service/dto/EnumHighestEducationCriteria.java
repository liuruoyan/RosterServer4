...
/**
 * Criteria class for the {@link com.cc.domain.EnumHighestEducation} entity. This class is used
 * in {@link com.cc.web.rest.EnumHighestEducationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-highest-educations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumHighestEducationCriteria implements Serializable, Criteria {
    ...
    public EnumHighestEducationCriteria(){
    }

    public EnumHighestEducationCriteria(EnumHighestEducationCriteria other){
    ...
    @Override
    public EnumHighestEducationCriteria copy() {
        return new EnumHighestEducationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumHighestEducationCriteria that = (EnumHighestEducationCriteria) o;
        return
    ...
    public String toString() {
        return "EnumHighestEducationCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
