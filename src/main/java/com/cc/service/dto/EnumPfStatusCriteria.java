...
/**
 * Criteria class for the {@link com.cc.domain.EnumPfStatus} entity. This class is used
 * in {@link com.cc.web.rest.EnumPfStatusResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-pf-statuses?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumPfStatusCriteria implements Serializable, Criteria {
    ...
    public EnumPfStatusCriteria(){
    }

    public EnumPfStatusCriteria(EnumPfStatusCriteria other){
    ...
    @Override
    public EnumPfStatusCriteria copy() {
        return new EnumPfStatusCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumPfStatusCriteria that = (EnumPfStatusCriteria) o;
        return
