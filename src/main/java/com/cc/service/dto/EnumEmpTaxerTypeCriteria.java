...
/**
 * Criteria class for the {@link com.cc.domain.EnumEmpTaxerType} entity. This class is used
 * in {@link com.cc.web.rest.EnumEmpTaxerTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-emp-taxer-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumEmpTaxerTypeCriteria implements Serializable, Criteria {
    ...
    public EnumEmpTaxerTypeCriteria(){
    }

    public EnumEmpTaxerTypeCriteria(EnumEmpTaxerTypeCriteria other){
    ...
    @Override
    public EnumEmpTaxerTypeCriteria copy() {
        return new EnumEmpTaxerTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumEmpTaxerTypeCriteria that = (EnumEmpTaxerTypeCriteria) o;
        return
    ...
    public String toString() {
        return "EnumEmpTaxerTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
