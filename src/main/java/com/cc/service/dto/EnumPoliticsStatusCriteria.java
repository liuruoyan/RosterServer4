...
/**
 * Criteria class for the {@link com.cc.domain.EnumPoliticsStatus} entity. This class is used
 * in {@link com.cc.web.rest.EnumPoliticsStatusResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-politics-statuses?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumPoliticsStatusCriteria implements Serializable, Criteria {
    ...
    public EnumPoliticsStatusCriteria(){
    }

    public EnumPoliticsStatusCriteria(EnumPoliticsStatusCriteria other){
    ...
    @Override
    public EnumPoliticsStatusCriteria copy() {
        return new EnumPoliticsStatusCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumPoliticsStatusCriteria that = (EnumPoliticsStatusCriteria) o;
        return
    ...
    public String toString() {
        return "EnumPoliticsStatusCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
