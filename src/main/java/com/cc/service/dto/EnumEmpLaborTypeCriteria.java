...
/**
 * Criteria class for the {@link com.cc.domain.EnumEmpLaborType} entity. This class is used
 * in {@link com.cc.web.rest.EnumEmpLaborTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /enum-emp-labor-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EnumEmpLaborTypeCriteria implements Serializable, Criteria {
    ...
    public EnumEmpLaborTypeCriteria(){
    }

    public EnumEmpLaborTypeCriteria(EnumEmpLaborTypeCriteria other){
    ...
    @Override
    public EnumEmpLaborTypeCriteria copy() {
        return new EnumEmpLaborTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EnumEmpLaborTypeCriteria that = (EnumEmpLaborTypeCriteria) o;
        return
    ...
    public String toString() {
        return "EnumEmpLaborTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
